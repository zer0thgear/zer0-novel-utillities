...
- **Enhance, as NovelAI's client does it.**
  ...
  - **Size:** plain multiplication, rounded down, so **1.5× of 832×1216 requests 1248×1824**, not 1280×1856. The client resizes the source to that size itself (see the previous item).
